...
<?php
$this->start('sidebar');
echo $this->Html->link("<span class=\"glyphicon glyphicon-chevron-left\"></span> Back to Liquidation Form", array('controller' => 'disbursements', 'action'=>'view', $disbursement['Liquidation']['id']),array('escape' => false, 'class' => 'btn btn-info') );
$this->end();
?>